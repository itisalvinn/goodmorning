...
table = soup.find('table', class_='t-home-table').find_all('tr', {"class":"styled-row is-bordered is-rounded"})
...
# scrape data in Major News table
# should this be updated to grab from main chart page?
